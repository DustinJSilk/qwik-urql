...
import { Exchange, Operation, OperationResult } from '@urql/core/dist/types';
...
export interface SSRExchangeParams {
  ...
  store?: Record<string, SerializedResult | null>;
}
...
export const ssrExchange = (params: SSRExchangeParams = {}): SSRExchange => {
  ...
  const data: Record<string, SerializedResult | null> = params.store ?? {};
